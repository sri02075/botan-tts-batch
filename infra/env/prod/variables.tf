...
variable "service_configs_v2" {
  ...
  default = {
    apartment: {
      ...
      services: {
        admin: { port: 3000, cpu: 512 },
        user: { port: 3001 },
        internal: { port: 3002, internal: true, cpu: 1024, task: 2 },
        device: { port: 3003 },
      }
    },
    audit: {
    ...
    device: {
      ...
      services: {
        admin: { port: 3000, cpu: 2048 },
        user: { port: 3001, cpu: 1024 },
        internal: { port: 3002, internal: true },
        device: { port: 3003, cpu: 2048, task: 4, max: 20 },
        schedule: { cpu: 512, internal: true, max: 1 },
      }
    },
    pbx: {
      priority: 24,
    ...
    payment: {
      priority: 30,
      health_check: "/payment/common/health/ping",
      services: {
        admin: { port: 3000 },
        user: { port: 3001 },
        internal: { port: 3002, internal: true },
